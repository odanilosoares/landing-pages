...
(function () {
  ...
  var HTML = ''
    ...
    + '<p>Uso cookies para medir a audi\u00eancia e mensurar as campanhas de an\u00fancio. '
    + 'Voc\u00ea escolhe o que autorizar. Detalhes na <a href="/politica-de-privacidade">Pol\u00edtica de Privacidade</a>.</p>'
    + '<div class="ds-op" id="ds-op">'
    + '<label><input type="checkbox" id="ds-an" checked><span><b>An\u00e1lise de audi\u00eancia</b>Google Analytics 4: p\u00e1ginas visitadas, origem do acesso e convers\u00f5es.</span></label>'
    + '<label><input type="checkbox" id="ds-mk" checked><span><b>Publicidade</b>Google Ads, Meta Pixel e YouTube: mensura\u00e7\u00e3o de an\u00fancios e remarketing.</span></label>'
    + '</div>'
    + '<div class="ds-btns">'
